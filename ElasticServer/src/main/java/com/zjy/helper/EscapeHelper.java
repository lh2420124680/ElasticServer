...
public class EscapeHelper {
	...
	public static void main(String[] args) {
		String test = "%7B%22quickaudit%22%3A%22true%22%2C%22quickaudit_remark%22%3A%22%u4E00%u4E8C%u4E09%u56DB%u4E94%u516D%u4E03%u516B%u4E5D%u5341@%u4E00%u4E8C%u4E09%u56DB%u4E94%u516D%u4E03%u516B%u4E5D%u5341%u4E00%u4E8C%u4E09%u56DB%u4E94%u516D%u4E03%u516B%u4E5D%u5341%u4E00%u4E8C%u4E09%u56DB%u4E94%u516D%u4E03%u516B%u4E5D%u5341%u4E00%u4E8C%u4E09%u56DB%u4E94%u516D%u4E03%u516B%u4E5D%u5341%22%7D";
		String yrl = "http://www.0898zlb.com:8300/ecp/data/sss.do?user=1";
		System.out.println(escape(yrl));
		System.out.println(unescape(test));
	}
}
